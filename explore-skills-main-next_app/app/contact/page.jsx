...
import Input_Contact_Form from "./(components)/Input_Contact_Form";
    ...
    <>
      ...
      <section className="contact-us">
        <div className="row">
          ...
          <div className="content-col">
            <form>
              <Input_Contact_Form type="text" place="Enter Name" />
              <Input_Contact_Form type="email" place="Enter Email" />
              <Input_Contact_Form place="Enter Subject" />
              <textarea
                rows="8"
                placeholder="Message"
                required
